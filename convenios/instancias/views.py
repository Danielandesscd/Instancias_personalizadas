...
def radicado_prof_titulado(request):
    try:
        ...
        tituloprofesional = request.POST.get('titulo-profesional', '')
        matriculaprofesional = request.POST.get('matricula-profesional', '')
        emisortarjetaprofesional = request.POST.get('emisor-tarjeta-profesional', '')
