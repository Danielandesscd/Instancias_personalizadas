# Generated by Django 5.0.2 on 2024-05-03 20:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('formatos_entrega', models.ManyToManyField(related_name='convenios', to='instancias.formatoentrega')),
                ('operaciones_certificado', models.ManyToManyField(related_name='convenios', to='instancias.operacioncertificado')),
                ('operaciones_firmado', models.ManyToManyField(related_name='convenios', to='instancias.operacionfirmado')),
                ('operaciones_otp', models.ManyToManyField(related_name='convenios', to='instancias.operacionotp')),
                ('certificados_seleccionados', models.ManyToManyField(related_name='convenios', to='instancias.tipo_cert')),
                ('tipos_certificado', models.ManyToManyField(related_name='convenios', to='instancias.tipocertificado')),
                ('vigencias_certificado', models.ManyToManyField(related_name='convenios', to='instancias.vigenciacertificado')),
            ],
        ),
        migrations.CreateModel(
